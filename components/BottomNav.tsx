...
import { Home, CalendarDays, Activity, HeartPulse } from "lucide-react";
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-bg-line bg-bg/85 backdrop-blur-xl">
      <div className="mx-auto max-w-screen-md grid grid-cols-4 px-2 pt-2 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
